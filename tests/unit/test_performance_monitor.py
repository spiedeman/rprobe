...
class TestCompareAllModes:
    ...
    @patch('src.utils.performance_monitor.SmartChannelReceiver')
    @patch('src.utils.performance_monitor.SSHConfig')
    ...
    def test_monitor_performance_adaptive_mode(self, mock_config_class, mock_receiver_class, capsys):
        """测试 Adaptive 模式的性能监控"""
        mock_config = Mock()
        mock_config_class.return_value = mock_config
    ...
    @patch('src.utils.performance_monitor.SmartChannelReceiver')
    @patch('src.utils.performance_monitor.SSHConfig')
    def test_monitor_performance_original_mode(self, mock_config_class, mock_receiver_class, capsys):
        """测试 Original 模式的性能监控"""
        mock_config = Mock()
        mock_config_class.return_value = mock_config
    ...
    @patch('src.utils.performance_monitor.SmartChannelReceiver')
    @patch('src.utils.performance_monitor.SSHConfig')
    def test_monitor_performance_python_version(self, mock_config_class, mock_receiver_class, capsys):
        """测试显示 Python 版本"""
        mock_config = Mock()
        mock_config_class.return_value = mock_config
...
class TestMain:
    ...
    @patch('src.utils.performance_monitor.monitor_performance')
    ...
    @patch('src.utils.performance_monitor.compare_all_modes')
    ...
    @patch('src.utils.performance_monitor.show_usage_examples')
...
class TestModuleExecution:
    ...
    @patch('src.utils.performance_monitor.main')
...
class TestEdgeCases:
    ...
    @patch('src.utils.performance_monitor.SmartChannelReceiver')
    @patch('src.utils.performance_monitor.SSHConfig')
    def test_compare_with_empty_performance_info(self, mock_config_class, mock_receiver_class, capsys):
        """测试性能信息为空字段时的处理"""
        mock_config = Mock()
        mock_config_class.return_value = mock_config
