...
def get_config():
    """获取SSH配置（从环境变量或代码）"""
    # 尝试从环境变量加载，使用占位符作为默认值
    host = os.environ.get("REMOTE_SSH_HOST", "your-host.com")
    username = os.environ.get("REMOTE_SSH_USERNAME", "your-username")
    password = os.environ.get("REMOTE_SSH_PASSWORD", "your-password")
